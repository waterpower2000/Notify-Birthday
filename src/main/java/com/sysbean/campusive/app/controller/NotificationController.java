            ...
            for (String ph : phoneNumbers){
                ...
                if(!createNotificationDTO.getFile().isEmpty()) {
                    ...
                    if(fileExtension.equals("jpg") || fileExtension.equals("jpeg")) {
                        ...
                        result = restTemplate.getForObject("http://95.217.47.189/wapp/api/send?apikey=efddfa9ea6b04bcdaad2384ef76d51e0&mobile="+ph+
            ...
            for (String phoneNumber : createNotificationDTO.getPhoneNumbers()){
                ...
                if(!createNotificationDTO.getFile().isEmpty()) {
                    ...
                    if(fileExtension.equals("pdf")) {
                        result = restTemplate.getForObject("http://95.217.47.189/wapp/api/send?apikey=efddfa9ea6b04bcdaad2384ef76d51e0&mobile=" +phoneNumber+
                                "&msg="+createNotificationDTO.getNotificationBody()+"&pdf="+fileLink, NotificationResponseDTO.class);
